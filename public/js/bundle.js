    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          try {} catch (err) {
            (0, _alerts.showAlert)("error", "We had a problem logging you out😥️. Try again");
          }
        case 5:
        case "end":
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "".concat(type === "password" ? "Password" : "Bio data", " updated succcessfully"));
          }
          _context.next = 11;
          break;
        case 8:
...
var saveSettings = document.querySelector(".form-user-data");
